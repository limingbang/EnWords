...
public class ZWSignCalendarView extends FrameLayout {
    ...
    private void initPager() {
        ...
        Log.d(Constant.TAG, "selectDay:" + selectDay);
    ...
    private ZWSignCalendar getContent(int position) {
        ...
        if (destroyViews.size() != 0) {
            ...
            calendarView.setDateSelectListener(new ZWSignCalendar.DateSelectListener() {
                @Override
                public void dateSelect(int year, int month, int day) {
                    selectYear = year;
                    selectMonth = month;
                    selectDay = day;
                    ...
                    if (listener != null) {
                        listener.select(year, month + 1, day);
                    }
                }
            });
...
//        listener.select(selectYear, selectMonth + 1, selectDay);
    }
    ...
    public void selectDate(int year, int month, int day) {
        ...
        int dayTemp = calendar.get(Calendar.DATE);
